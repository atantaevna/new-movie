...
import {GetActorsDetails} from "../../store/Reducer/DetailActors";
...
const ActorPeople = () => {
    ...
    return (
        <div className='flex p-8'>
            <img src={`https://www.themoviedb.org/t/p/w300_and_h450_bestv2/${DetailActor.profile_path}`} width={400} alt=""/>
            <div className='ml-10'>
